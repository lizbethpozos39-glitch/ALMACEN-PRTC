...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $tipo_cliente  = trim($_POST["tipo_cliente"] ?? "EMPRESA");
    ...
    if ($nombre === "") {
        ...
        /* =================================================
           VERIFICAR RFC SI FUE CAPTURADO
        ================================================= */
        ...
        if ($rfc !== "") {
            ...
            if ($stmt_rfc) {
                ...
                if ($resultado_rfc->num_rows > 0) {
                    ...
                    $mensaje = "Ya existe un cliente registrado con ese RFC: "
        ...
        if ($mensaje === "") {
            ...
            if (!$stmt) {
                ...
                if ($stmt->execute()) {
                    ...
                    /*
                     * Redirigimos al detalle del cliente
                     * para evitar que el formulario se vuelva
                     * a enviar al actualizar la página.
                     */
...
<head>
    ...
    <title>Nuevo cliente - Sistema Comercial</title>
...
<aside class="sidebar">
    ...
    <a href="nuevo_cliente.php" class="activo">
        Nuevo cliente
    </a>
...
<main class="contenido">
    ...
    <div class="encabezado">
        ...
        <div>
            ...
            <p>
                Registra un nuevo cliente para utilizarlo posteriormente
                en cotizaciones y seguimiento comercial.
            </p>
        </div>
        ...
        <div class="seccion">
            ...
            <div class="grid">
                ...
                <div class="campo">
                    ...
                    <div class="ayuda">
                        Se verificará que no exista otro cliente con el mismo RFC.
                    </div>
...
<script>
    ...
    /*
     * Convertir RFC a mayúsculas mientras se captura.
     */
    ...
    /*
     * Si es PERSONA, la razón social no es obligatoria.
     * Si es EMPRESA, solamente mostramos una pequeña ayuda
     * visual mediante el placeholder.
     */
    ...
    function actualizarRazonSocial() {
        ...
        if (tipoCliente.value === "EMPRESA") {
            ...
            razonSocial.placeholder = "Razón social de la empresa";

        } else {

            razonSocial.placeholder = "Opcional";
